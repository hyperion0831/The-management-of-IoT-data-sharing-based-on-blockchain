  ...
  <div class="datadashboard">
    ...
    <div class="sidebar">
      ...
      <ul>
        ...
        <li :class="{ active: activeModule === 'StepMonitoring' }" @click="selectModule('StepMonitoring')">
          步数分析
        </li>
...
import StepMonitoring from './dashboard/StepMonitoring.vue';
