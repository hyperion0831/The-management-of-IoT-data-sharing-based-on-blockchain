...
export default {
  ...
  mounted() {
    ...
    const savedPublicKey = localStorage.getItem("displayPublicKey");
    const savedPrivateKey = localStorage.getItem("displayPrivateKey");
    ...
    if (savedPublicKey && savedPrivateKey) {
      this.displayPublicKey = savedPublicKey;
      this.displayPrivateKey = savedPrivateKey;
    }
  },
  methods: {
    // 新增视图切换方法
